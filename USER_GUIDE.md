...
1. Enter Email
2. Tap "Send OTP"
3. OTP is generated and stored locally
4. Enter OTP within 60 seconds
5. Maximum 3 attempts allowed
6. On success → Session screen opens
7. Session duration timer starts
8. Logout → Session cleared
9. App restart → Login persists until logout

------------------------------------------------------------------------

# Session Persistence Behavior

- If logged in → App opens directly to Session screen
- If logged out → App opens to Login screen
...
Make sure node modules installed 
- Run: npm install 
